...
```
> The server config for deployment is in `com.assignment.EmbeddingJettyStarter`.
>
> Feel free to configure it.
...
In `com.assignment.EmbeddingJettyStarter`, you can directly change the port or the context path by:
